...
class Carousel {
  constructor(el) {
    ...
    this.carouselData = [
      {
        'id': '1',
        'src': 'images/gloamGirl.jpg',
      },
      {
        'id': '2',
        'src': 'images/momDaughterDonut.jpg',
      },
      {
        'id': '3',
        'src': 'images/GLOAMingo.png',
      },
      {
        'id': '4',
        'src': 'images/lakeDate.jpg',
      },
      {
        'id': '5',
        'src': 'images/momAndSon.jpg',
      },
      {
        'id': '6',
      ...
      {
        'id': '7',
        'src': 'images/2kidsDuck.jpg',
      },
      {
        'id': '8',
        'src': 'images/2girlsFlamingo.jpg',
      }
    ];
