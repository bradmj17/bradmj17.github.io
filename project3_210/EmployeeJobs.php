...
//query that only gets the signed in employee assignments.
global $id;
...
$queryTicketsss = "SELECT *
                   ...
                   WHERE jobs_assigned.EmployeeID = '$id'
...
<section class="section4">
        ...
        <h2>You are currently sorting by jobs assigned to employee #<?php echo $id; ?></h2><br><br><br><br><br>
      <div class="section4" style="margin-left:4%;margin-right:2%">
          ...
          <input type="submit" value="Sort by ticket#" style=" background-color:whitesmoke;" class="center">
            ...
            <form action="SortedEmployee.php" method="post" style="width:80%;" class="center" >
                    <input type="hidden" name="id"
                           value="<?php echo $id; ?>">
          <input type="submit" value="Sort by employee" style=" background-color:whitesmoke;" class="center">
      </form>
    <form action="EmployeeJobs.php" method="post" style="width:80%;" class="center">
                    <input type="hidden" name="id"
                           value="<?php echo $id; ?>">
          <input type="submit" value="Sort by your jobs" style=" background-color:whitesmoke;" class="center colorG" disabled>
      </form>
